...
if uploaded_file is not None:   # runs the web app when csv uploaded
    ...
    pivottabltransactiontype = pd.pivot_table(df, index=['Transaction_Type'],
    ...
    pivottabltransactioncountry['totalpercent'] = (pivottabltransactioncountry['Total'] / totalsum).apply(
        '{:.2%}'.format)
